...
const Footer = () => {
  return (
    <footer className="bg-black text-gray-300 pt-12 pb-8 border-t-4 border-[#E83030]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            <div className="text-[#E83030] text-xl font-bold tracking-widest">JUALIN</div>
            ...
            <div className="mt-6">
              <div className="text-[#E83030] font-semibold">Temukan Kami</div>
              <div className="mt-3 flex items-center gap-4">
                <a aria-label="Facebook" href="#" className="hover:text-[#E83030]">
                ...
                <a aria-label="Instagram" href="#" className="hover:text-[#E83030]">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a aria-label="X" href="#" className="hover:text-[#E83030]">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M3 3h4.7l4.2 6.1L16.9 3H21l-7.4 9.9L21 21h-4.8l-4.6-6.7L7.1 21H3l7.7-10.2L3 3Z"/>
                  </svg>
                </a>
                <a aria-label="YouTube" href="#" className="hover:text-[#E83030]">
                ...
                <a aria-label="LinkedIn" href="#" className="hover:text-[#E83030]">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="md:col-span-2">
            <div className="text-[#E83030] font-semibold">Download App Kami</div>
            <div className="mt-4 flex flex-wrap gap-4">
              <a href="#" className="inline-flex items-center gap-2 rounded-lg border border-[#E83030] text-[#E83030] px-4 py-2 hover:bg-[#E83030] hover:text-white hover:border-[#E83030]">
        ...
        <div className="mt-10 border-t border-[#E83030] pt-6 flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
          <div className="text-gray-400">© {new Date().getFullYear()} Jualin</div>
          <div className="flex flex-wrap gap-4">
            <a href="/kebijakan-privasi" className="hover:text-[#E83030]">Kebijakan Privasi</a>
            <a href="/syarat-ketentuan" className="hover:text-[#E83030]">Syarat & Ketentuan</a>
            <a href="/kontak" className="hover:text-[#E83030]">Kontak</a>
          </div>
        </div>
      </div>
    </footer>
