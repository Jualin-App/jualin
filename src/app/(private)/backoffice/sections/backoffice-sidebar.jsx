      ...
      <div className="p-6">
        <div className="mb-8">
          ...
          <nav className="space-y-3">
            ...
            <Link
              href="/backoffice"
              className={`w-full flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 shadow-sm hover:shadow-md hover:scale-[1.02] cursor-pointer ${
                isActive("/backoffice")
            ...
            >
              <LayoutDashboard
                className={`mr-3 h-5 w-5 ${
                  isActive("/backoffice") ? "text-[#E83030]" : "text-gray-500"
                }`}
              />
              Management User
            </Link>
            ...
            <Link
              ...
              className={`w-full flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 shadow-sm hover:shadow-md hover:scale-[1.02] cursor-pointer ${
                isActive("/backoffice/super-admin")
                  ? "bg-white text-[#E83030] font-bold ring-2 ring-white/20"
                  : "bg-white text-gray-700 hover:bg-gray-50"
              }`}
            >
