    ...
    <div className="w-64 bg-[#E83030] min-h-screen flex flex-col rounded-r-3xl">
      <div className="p-6 flex-1">
        <div className="space-y-8">
          {/* PROFILE Section */}
          <div>
            <h3 className="text-xs font-bold text-white/90 uppercase tracking-wider mb-4 px-1">PROFIL</h3>
            <nav className="space-y-3">
              ...
              >
                <svg className={`mr-3 h-5 w-5 ${activeTab === "edit" ? "text-[#E83030]" : "text-gray-500"}`} fill="currentColor" viewBox="0 0 20 20">
              ...
              >
                <svg className={`mr-3 h-5 w-5 ${activeTab === "purchases" ? "text-[#E83030]" : "text-gray-500"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
